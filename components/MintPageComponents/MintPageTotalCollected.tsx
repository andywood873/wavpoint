...
export default function MintPageTotalCollected({collectedNumber}: MintPageTotalCollectedInterface) {
    ...
    return <div className="absolute z-20 top-[8rem] md:top-[8rem] lg:top-[7rem] xl:top-[3rem] xl:hidden xl:mr-[5rem] right-[4rem] md:right-[0.3rem] sm:top-[5rem]  bg-[#F5F5F5] px-10 py-5 md:px-5 md:py-2.5 rounded-full">
