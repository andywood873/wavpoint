	...
	return (
		<div className="relative font-azeretcus ">
			<MintPageAudioPlayerContextProvider>
				...
				<Center className="relative md:-top-[10rem] flex flex-col lg:p-[10rem] lg:pt-0">
					<div className="md:grid md:grid-cols-2 md:gap-4 md:items-start">
						<div className="relative container w-full ">
							<MintPageCard />
							<div className="container relative w-full">
							<MintPageTotalCollected collectedNumber={collectedNumber} /></div>
						</div>
					...
					<div className="relative container px-[2.2rem] top-[25rem] md:grid md:grid md:grid-rows-2 md:text-left md:mt-10">
						<div className="md:relative md:order-2 md:-top-[25rem]">
							<h2 className="text-3xl text-[#FF6700] font-normal">Tracklist</h2>
